...
本地目录已按源码、文档、平台交付整理。当前 Android 为 **2.3.0**，Windows 为 **1.4.0**，两个平台独立编号。
...
| Windows | 1.4.0 | [Windows 交付目录](最终交付/Windows/Orbbound-Windows-1.4.0/) | 单文件便携 EXE、7z、SHA-256、完整 win-unpacked 运行目录 |

所有旧版本保留在对应平台目录内。Windows 1.0.0 的两个不同本地构建按原来源分别保存，不将其视作同一文件。

下载：[Windows 1.4.0 单文件 EXE](https://github.com/Nanami0923/Orbbound/releases/download/windows-v1.4.0/Orbbound-Windows-1.4.0-Portable-x64.exe) · [完整游戏目录 7z](https://github.com/Nanami0923/Orbbound/releases/download/windows-v1.4.0/Orbbound-Windows-1.4.0-x64.7z)
...
Windows 1.4.0 同步移动端 2.0–2.3 的模式、存档、排行榜及转向功能，保留桌面鼠标 / 键盘操作。[Windows 1.4.0 更新说明](docs/releases/Windows/windows-1.4.0-notes.md)。
